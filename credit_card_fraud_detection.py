...
Original file is located at
    https://colab.research.google.com/drive/1rbQcrMeLDh074iU32her2N_oFTJIrbDb
...
"""#Step2: Check for any null values in the dataset."""

data.isnull().values.any()

#there are no null values in the dataset

"""#Step 3: Summary of the 'Amount' Feature"""

data['Amount'].describe()

"""#Step 4: Check the number of occurences of each class label"""
...
print('Pectentage of Fraud transactions: {:.5f}'.format(fraud_percent))

"""#Step 5: Plot the above information using matplotlib"""
...
#Step 6: Let's apply scaling techniques on the 'Amount' Feature to transform the range of the values

We drop the original “Amount” column and add a new column with the scaled values. We also drop the “Time” column as it is irrelevant.
"""
...
"""#Sep 7: Now spli the data with a split of 70-30 using train_test_split()."""
...
"""#Step 8: Apply Machine Learning algorithms to the dataset
...
"""#Step 9: Train and Evaluate our Models on the Dataset"""
...
print(f"Decision Tree Score: {decision_tree_score:.2f}%")

"""#Step 10: Let’s create a function to print the metrics: accuracy, precision, recall, and f1-score."""
...
"""#Step 11: Let’s visualize the confusion matrix and the evaluation metrics of our Decision Tree model."""

#Plot the confusion matrix for Decision Trees
...
display = ConfusionMatrixDisplay(confusion_matrix=confusion_matrix_dt, display_labels=[0, 1])
...
"""#Step 12: Let’s visualize the confusion matrix and the evaluation metrics of our Random Forest model."""
...
display = ConfusionMatrixDisplay(confusion_matrix=confusion_matrix_rf, display_labels=[0, 1])
display.plot(cmap=plt.cm.Blues)
...
"""#Step 13:Address the Class-Imbalance issue
...
print('Resampled shae of X: ', X_resampled.shape)
print('Resampled shae of Y: ', Y_resampled.shape)
...
resampled_score_resampled = rf_resampled.score(test_X, test_Y) * 100
...
display = ConfusionMatrixDisplay(confusion_matrix=cm_resampled, display_labels=[0, 1])
display.plot(cmap=plt.cm.Blues)
